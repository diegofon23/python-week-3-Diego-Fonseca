...
priceOfaBook = 39.99
print(dollars)
total = dollars + priceOfaBook
print(total)
print(type(total))


money_for_movie = input("how much money do you have?")
money_for_dinner = input("how much money do you have for dinner?")
...
#implicit means it is inferred by the program
#explicit means it is explcitly defined
